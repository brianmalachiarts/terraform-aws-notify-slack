...
def format_cloudwatch_alarm(message: Dict[str, Any], region: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "mrkdwn_in": ["text"],
        "text": f"*{alarm_name}* - <{cloudwatch_url}#alarm:alarmFilter=ANY;name={urllib.parse.quote(alarm_name)}|alarm> - <{cloudwatch_url}#logsV2:log-groups/log-group/organization-cloudtrail-logs/log-events$3FfilterPattern$3D{urllib.parse.quote(message['AlarmDescription'])}$26start$3D-3600000|logs>",
